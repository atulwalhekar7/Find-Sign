    ...
    Discover top suburbs for high growth, rental yield, and long-term returns
      ...
      <main style={{ maxWidth: "1300px", margin: "0 auto", padding: "0 40px" }}>
        ...
        <section style={{ padding: "60px 0" }}>
          <h2
            tabIndex={0}
            style={{ fontFamily: "GT Super Display Medium", fontSize: "44px", color: "var(--text-heading)", textAlign: "center", marginBottom: "50px" }}
          >
            Top Suburbs in Perth for Property Investment
          </h2>
          <div
            className="top-suburbs-grid"
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  borderRight: i % 2 === 0 ? "1px solid var(--bg-tertiary)" : "none",
                }}
              >
                <h3 tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "28px", color: "var(--text-heading)", marginBottom: "16px" }}>
                  {suburb.name}
                </h3>
                <ul style={{ display: "flex", flexDirection: "column", gap: "8px", padding: 0, margin: 0, listStyle: "none" }}>
                  {suburb.why.map((item, j) => (
                    <li key={j} tabIndex={0} style={{ fontSize: "18px", color: "var(--text-secondary)", display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <section style={{ padding: "60px 0", backgroundColor: "var(--bg-secondary)" }}>
          <h2 tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "44px", color: "var(--text-heading)", textAlign: "center", marginBottom: "50px" }}>
            Emerging Suburbs to Watch in 2026
          </h2>
          <p tabIndex={0} style={{ fontSize: "20px", textAlign: "center", maxWidth: "800px", margin: "0 auto 50px", color: "var(--text-secondary)" }}>
          ...
          <div className="emerging-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "40px" }}>
            {[
              ...
              <div key={i} style={{ textAlign: "center", padding: "24px 16px" }}>
                <div style={{ width: "48px", height: "48px", borderRadius: "50%", border: "2px solid #69E4DC", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px", fontFamily: "GT Super Display Medium", fontSize: "20px", color: "var(--text-heading)" }}>
                  {i + 1}
                </div>
                <h3 tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "24px", color: "var(--text-heading)", marginBottom: "12px" }}>{suburb.name}</h3>
                <p tabIndex={0} style={{ fontSize: "18px", color: "var(--text-secondary)", margin: 0, lineHeight: "1.6" }}>{suburb.desc}</p>
              </div>
            ))}
          </div>
        </section>
...
/>
        ...
        <section style={{ padding: "60px 0", borderTop: "1px solid var(--bg-tertiary)" }}>
          <h2 tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "44px", color: "var(--text-heading)", marginBottom: "40px", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0", maxWidth: "900px", margin: "0 auto" }}>
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "center", gap: "20px", padding: "24px 0", borderBottom: "1px solid var(--bg-tertiary)" }}>
                <span tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "28px", color: "var(--text-heading)", lineHeight: 1, minWidth: "36px" }}>
                  {String(i + 1).padStart(2, "0")}
                </span>
                <p tabIndex={0} style={{ margin: 0, fontSize: "18px", color: "var(--text-primary)" }}>{mistake}</p>
              </div>
            ))}
          </div>
        </section>
  ...
  reverse
        ...
        {/* ── Trends ── (racing green — same in both modes, like footer) */}
        <section style={{ padding: "60px 0", backgroundColor: "#073B2F", borderRadius: "24px", color: "#FFF", marginBottom: "60px" }}>
          <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
            <h2 tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "44px", marginBottom: "32px" }}>
        ...
        {/* ── Final Thoughts ── */}
        <section style={{ padding: "40px 0", borderTop: "1px solid var(--bg-tertiary)", backgroundColor: "var(--bg-secondary)", textAlign: "center" }}>
          <div style={{ maxWidth: "900px", margin: "0 auto", padding: "0 40px" }}>
            <h2 tabIndex={0} style={{ fontFamily: "GT Super Display Medium", fontSize: "44px", color: "var(--text-heading)", marginBottom: "32px" }}>
              Final Thoughts
            </h2>
            <p tabIndex={0} style={{ fontSize: "20px", color: "var(--text-secondary)", lineHeight: "1.7", maxWidth: "800px", margin: "0 auto 40px" }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    ...(open ? { borderLeft: "4px solid var(--text-heading)" } : {}),
                  }}
                >
                  <button
                  ...
                  >
                    <span tabIndex={0} style={{ fontSize: "20px", color: open ? "var(--text-heading)" : "var(--text-primary)", fontFamily: "'Sohne', sans-serif", fontWeight: open ? 500 : 400, flex: 1, transition: "color 0.3s ease" }}>
                      {faq.q}
                    </span>
                    <svg
                      style={{ width: "20px", height: "20px", flexShrink: 0, color: "var(--text-heading)", transform: open ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)" }}
                      viewBox="0 0 20 20"
                      fill="none"
                    >
                  ...
                  {open && (
                    <div style={{ padding: "0 32px 24px", borderTop: "1px solid var(--bg-tertiary)" }}>
                      <p tabIndex={0} style={{ color: "var(--text-secondary)", fontSize: "18px", lineHeight: "1.6", margin: 0, paddingTop: "16px" }}>
                        {faq.a}
                      </p>
                    </div>
                  )}
