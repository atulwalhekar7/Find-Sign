...
export default function Services() {
  ...
  const body3 = "Before making the right property decision, having the right financial foundation is essential. A Perth buyer’s agent can help you understand the buying process while working alongside the right finance professionals to ensure your property goals are supported from the beginning.";
  const body4 = "The legal side of purchasing a property involves many important details that require careful attention. A trusted buyer’s advocate Perth works alongside experienced settlement professionals to ensure contracts are handled correctly, deadlines are managed, and your property purchase progresses smoothly and securely.";
  ...
  const body6 = "Once you have secured your investment, you need the right support to protect and manage your property. A Perth buyer’s agent can help connect you with reliable property management solutions that protect your asset, support your tenants, and help keep your investment performing for the long term.";
  const body7 = "Two of the most overlooked yet valuable members of your property investment team. A trusted buyer’s advocate Perth can help you connect with the right professionals, ensuring your investment structure is effective, depreciation opportunities are maximised, and available financial benefits are considered.";
  const body8 = "Whether you are selling before you buy or planning your next investment move, having a strong property network can ensure you have the right guidance and connections when it matters most. Your Perth buyer’s agent team can help connect you with trusted professionals when the time comes.";
