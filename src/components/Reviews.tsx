...
const reviewsData = [
  ...
  { name: "Sahil Saini", date: "4 months ago", title: "Professional and great to work ", body: "Niki is professional and great to work with. His communication has been great for one of our clients to source a property before Christmas and met all deadlines. Not to mention the bargain he was able to secure for the property.", image: sahilSainiImg },
  ...
  { name: "Prashanth Nayar", date: "5 months ago", title: "Thorough market insights and dedicated ", body: "As a selling-agent based in Perth, I've found that Niki brings thorough market insights, dedicated due-diligence and a genuine commitment to finding the right property for his clients.", image: prashanthNayarImg },
  ...
  { name: "Kathy Moore", date: "7 months ago", title: "High level of professionalism", body: "I recently dealt with Niki for a property I was selling in Connolly, where he was representing the buyers. The whole process went smoothly, due to Niki's high level of professionalism, communication and efficiency." },
